...
export const SchoolStudentForm = ({
  formData,
  onChange,
  onSubmit,
  onBack
  ...
  return <form onSubmit={onSubmit} className="w-full">
      <div className="flex items-center mb-4">
        ...
        <h3 className="text-xl font-semibold">School Student Signup</h3>
      </div>
      ...
      <FormField name="classCode" value={formData.classCode} onChange={onChange} placeholder="Class Code/Class Name" required />
